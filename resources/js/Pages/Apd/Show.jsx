...
export default function Show({ auth, apd }) {
    // 🗓️ Format tanggal jadi Tahun-Bulan-Tanggal (tanpa jam)
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                ...
                                <div>
                                    <div className="mb-4">
                                        ...
                                        <p className="text-gray-800 dark:text-gray-200">{apd.id}</p>
                                    </div>
